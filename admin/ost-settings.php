...
<div class="key4ce_headtitle">osTicket Settings</div>
<div style="clear: both"></div>
<?php require_once( WP_PLUGIN_DIR . '/key4ce-osticket-bridge/admin/header_nav.php' ); ?>
<div id="key4ce_tboxwh" class="key4ce_pg1">Some simple plugin settings for Wordpress.</div>
<div style="clear: both"></div>
<?php 
...
<tr>
<td class="key4ce_config_td"><label class="key4ce_config_label">Support Center Status:</label></td>
...
<tr>
<td class="key4ce_config_td"><label class="key4ce_config_label">Helpdesk Name/Title:</label></td>                
...
<tr>
<td class="key4ce_config_td"><label class="key4ce_config_label">Maximum Open Tickets:</label></td>                
...
<tr>
<td class="key4ce_config_td"><label class="key4ce_config_label">Reply Separator Tag:</label></td>                
...
<tr>
<td class="key4ce_config_td"><label class="key4ce_config_label">SMTP Status</label></td>                
<td>
<?php 
